...
Module Registry
    ...
    Declare Function RegQueryValueEx_str Lib "advapi32.dll" Alias "RegQueryValueExA" (ByVal hKey As Integer, ByVal lpValueName As String, ByVal lpReserved As Integer, ByRef lpType As Integer, ByVal lpData As String, ByRef lpcbData As Integer) As Integer
    Declare Function RegQueryValueEx_dword Lib "advapi32.dll" Alias "RegQueryValueExA" (ByVal hKey As Integer, ByVal lpValueName As String, ByVal lpReserved As Integer, ByRef lpType As Integer, ByRef lpData As Integer, ByRef lpcbData As Integer) As Integer
    Declare Function RegSetValueEx_str Lib "advapi32.dll" Alias "RegSetValueExA" (ByVal hKey As Integer, ByVal lpValueName As String, ByVal Reserved As Integer, ByVal dwType As Integer, ByVal lpData As String, ByVal cbData As Integer) As Integer
    Declare Function RegSetValueEx_dword Lib "advapi32.dll" Alias "RegSetValueEx" (ByVal hKey As Integer, ByVal lpValueName As String, ByVal Reserved As Integer, ByVal dwType As Integer, ByRef lpData As Integer, ByVal cbData As Integer) As Integer
    ...
    Public Function GetString(ByRef hKey As Integer, ByRef strPath As String, ByRef strValue As String, Optional ByRef [default] As String = "") As String
        Dim r As Integer
        ...
        lResult = RegQueryValueEx_dword(keyhand, strValue, 0, lValueType, 0, lDataBufSize)
        If lValueType = REG_SZ Then
            strBuf = New String(" ", lDataBufSize)
            lResult = RegQueryValueEx_str(keyhand, strValue, 0, 0, strBuf, lDataBufSize)
            If lResult = ERROR_SUCCESS Then
                intZeroPos = InStr(strBuf, Chr(0))
                If intZeroPos > 0 Then
                    Return Left(strBuf, intZeroPos - 1)
                Else
                    Return strBuf
                End If
            End If
	...
	Public Sub SaveString(ByRef hKey As Integer, ByRef strPath As String, ByRef strValue As String, ByRef strdata As String)
		...
		Dim r As Integer
		r = RegCreateKey(hKey, strPath, keyhand)
        r = RegSetValueEx_str(keyhand, strValue, 0, REG_SZ, strdata, Len(strdata))
		r = RegCloseKey(keyhand)
	End Sub
	...
	Public Function GetdWord(ByVal hKey As Integer, ByVal strPath As String, ByVal strValueName As String) As Integer
        ...
        lResult = RegQueryValueEx_dword(keyhand, strValueName, 0, lValueType, lBuf, lDataBufSize)
	...
	Public Function SaveDword(ByVal hKey As Integer, ByVal strPath As String, ByVal strValueName As String, ByVal lData As Integer) As Object
		...
		Dim r As Integer
		r = RegCreateKey(hKey, strPath, keyhand)
        lResult = RegSetValueEx_dword(keyhand, strValueName, 0, REG_DWORD, lData, 4)
