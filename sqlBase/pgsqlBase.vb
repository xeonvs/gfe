...
Public Class Database
    ...
    Public Sub DeleteMessageByNum(ByRef NumberMessage As Integer) Implements IDatabases.DeleteMessageByNum
        '
    End Sub
    ...
    Public Sub GetHeadesByNum(ByRef NumberMessage As Integer) Implements IDatabases.GetHeadesByNum
        '
    End Sub

    Public Sub GetHeadesByNumAll(ByRef NumberMessage As Integer) Implements IDatabases.GetHeadesByNumAll
    ...
    Public Function GetLastReadMsgNum(Optional ByRef msgNumber As Integer = 0) As Integer Implements IDatabases.GetLastReadMsgNum
